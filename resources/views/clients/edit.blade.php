                    ...
                    <form action="{{route('clients.update', $client->id)}}" method="post" autocomplete="off">
                        ...
                        <div class="row">
                            <div class="col-lg-12 col-md-12 col-sm-12 mt-3">
                                ...
                                <input type="email" class="form-control" id="inputName" name="email"  value="{{$client->email}}">
                        ...
                        <div class="row">
                            <div class="col-lg-12 col-md-12 col-sm-12 mt-3">
                                ...
                                <input type="text" class="form-control" id="inputName" name="address"  value="{{$client->address}}">
